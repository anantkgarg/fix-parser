...
public class FIXMessageTest {
    ...
    public void testCopyMessage() {
        fixMessage.copyMessage(s.getBytes());
        Assert.assertNotNull("CopyMessage failed", fixMessage.getRawMessage());
        Assert.assertTrue("Bytes not equal", Arrays.equals(s.getBytes(), fixMessage.getRawMessage()));
    }

    @Test
    public void testUpdateTagIndex() throws InvalidMessageException {
    ...
    @Test
    public void testUpdateTagValueIndexAndLength() throws InvalidMessageException {
